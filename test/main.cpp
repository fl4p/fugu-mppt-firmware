...
void setup() {
    ...
    RUN_TEST(test_mcpwm_deadtime_runtime_change);
    RUN_TEST(test_mcpwm_deadtime_split_init);
    RUN_TEST(test_mcpwm_deadtime_lh_only);
    RUN_TEST(test_mcpwm_deadtime_split_runtime);
