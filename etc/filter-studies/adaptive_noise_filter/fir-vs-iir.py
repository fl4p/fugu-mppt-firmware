...
plt.plot(y, label='in')
plt.plot(y.rolling(80).mean(), label='fir80')
plt.plot(y.rolling(40).mean().rolling(40).mean(), label='fir40+40')
plt.plot(y.ewm(span=80).mean(), label='iir80')
plt.plot(y.ewm(span=40).mean().ewm(span=40).mean(), label='iir40+40')
